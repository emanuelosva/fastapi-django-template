...
def create_a_new_user(user_info: UserCreateDto, response: Response) -> UserDto:
...
def sent_recovery_password_email(email: str) -> any:
    """
    ...
    return responses.EmailMsg(detail=token)
